 ...
 */
public class PBKDF2_SHA1_AES256_HMAC_SHA1 extends PBKDF2_SHA1_AES256_HMAC_SHA256 {
	@Override
	public String name() {
		return "PBKDF2-SHA1-AES256-HMAC-SHA1";
	}

	@Override
	public CipherMacSpec create() {
		return new PBKDF2_SHA1_AES256_HMAC_SHA1();
	}
